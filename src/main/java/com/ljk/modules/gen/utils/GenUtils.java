...
import com.ljk.modules.common.utils.DateUtils;
import com.ljk.modules.common.utils.Utils;
import com.ljk.modules.gen.entity.ColumnEntity;
import com.ljk.modules.gen.entity.TableEntity;
...
public class GenUtils {
	...
	public static String getLocalFileName(String template, String className, String packageName){
		...
		if(template.contains("list.html.vm")){
			...
			//return config.getString("view")+ File.separator + className.toLowerCase();
		}
